...
public class UserServiceTests
{
    ...
    //substitute, proxy, in memory implementation of the interface:
    ...
    public async Task GetAllAsync_ShouldLogMessages_WhenInvoked()
    {
        ...
        _logger.Received(1).LogInformation(Arg.Is<string?>(x => x!.StartsWith("Retrieving"))); //A variable m of type T? is considered to be non-null when you apply the null-forgiving operator, as in m!.
